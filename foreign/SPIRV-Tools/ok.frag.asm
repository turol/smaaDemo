...
%float_0_142857 = OpConstant %float 0.142857
  ...
  %float_n33 = OpConstant %float -33
        %705 = OpConstantComposite %v2float %float_33 %float_n33
   %float_66 = OpConstant %float 66
        %363 = OpConstantComposite %v2float %float_66 %float_33
 %float_n0_5 = OpConstant %float -0.5
       %1567 = OpConstantComposite %v2float %float_0_5 %float_n0_5
%float_0_015625 = OpConstant %float 0.015625
%float_0_0625 = OpConstant %float 0.0625
       %1633 = OpConstantComposite %v2float %float_0_015625 %float_0_0625
...
%_ptr_Input_v2float = OpTypePointer Input %v2float
      ...
      %16722 = OpVectorShuffle %v2float %6933 %6933 0 1
      %23994 = OpCompositeExtract %float %16722 0
       %9412 = OpCompositeExtract %float %16722 1
       %9033 = OpCompositeConstruct %v3float %23994 %9412 %float_1
               OpBranch %20259
      %20259 = OpLabel
      %11194 = OpPhi %v2float %12938 %20854 %15275 %21237
      %14247 = OpPhi %v4float %18241 %20854 %10993 %21237
               OpLoopMerge %14333 %21237 None
               OpBranch %14369
      %14369 = OpLabel
      ...
      %17775 = OpCompositeExtract %float %16542 0
      ...
      %23995 = OpCompositeExtract %float %16723 0
       %9413 = OpCompositeExtract %float %16723 1
       %9034 = OpCompositeConstruct %v3float %23995 %9413 %float_1
               OpBranch %20278
      %20278 = OpLabel
      %11078 = OpPhi %v4float %18242 %13982 %10994 %21238
               OpLoopMerge %14334 %21238 None
               OpBranch %14370
      %14370 = OpLabel
      ...
      %14547 = OpVectorShuffle %v4float %9402 %17547 0 4 2 5
       %7457 = OpCompositeExtract %float %14547 0
      %18809 = OpCompositeExtract %float %14547 1
      ...
      %23370 = OpFAdd %float %14575 %float_0_25
      %21616 = OpFNegate %float %18809
       %9825 = OpFSub %float %21616 %float_0_25
       %9958 = OpFNegate %float %9825
      ...
      %13122 = OpCompositeConstruct %v2float %float_3_75 %float_3_75
      %24887 = OpFSub %v2float %22812 %13122
      ...
      %11931 = OpCompositeConstruct %v2float %float_0_9 %float_0_9
      %12613 = OpExtInst %v2float %1 Step %11931 %18891
      ...
      %20890 = OpFMul %float %float_0_142857 %float_0
       %9264 = OpCompositeExtract %float %21918 1
       %9452 = OpFAdd %float %9264 %20890
      %10324 = OpFSub %float %float_1 %9452
      ...
      %23596 = OpFAdd %v2float %1823 %20132
               OpBranch %20844
      %20844 = OpLabel
      %19748 = OpPhi %v2float %1823 %14334 %23596 %18718
      ...
      %14676 = OpCompositeInsert %v4float %19613 %18242 0
               OpBranch %21891
      %21891 = OpLabel
      %11079 = OpPhi %v4float %14676 %20844 %21594 %21239
               OpLoopMerge %14335 %21239 None
               OpBranch %14371
      %14371 = OpLabel
      ...
      %21600 = OpCompositeExtract %float %8764 0
      ...
      %15185 = OpFNegate %float %float_1
               OpBranch %10037
      %10037 = OpLabel
      %11195 = OpPhi %v2float %12938 %24046 %11653 %21240
      %14248 = OpPhi %v4float %14676 %24046 %21595 %21240
               OpLoopMerge %14336 %21240 None
               OpBranch %14372
      %14372 = OpLabel
      ...
      %21601 = OpCompositeExtract %float %8765 0
      ...
      %17776 = OpCompositeExtract %float %16543 1
      ...
      %14921 = OpFNegate %float %23966
       %7102 = OpFNegate %float %14921
      %10954 = OpFNegate %float %23848
      %21235 = OpCompositeConstruct %v4float %14921 %7102 %23848 %10954
      ...
      %11932 = OpCompositeConstruct %v2float %float_0_9 %float_0_9
      %12614 = OpExtInst %v2float %1 Step %11932 %18892
      ...
      %20891 = OpFMul %float %float_0_142857 %float_0
       %9265 = OpCompositeExtract %float %21919 1
       %9453 = OpFAdd %float %9265 %20891
      %10325 = OpFSub %float %float_1 %9453
      ...
      %12458 = OpCompositeExtract %float %20369 0
      %19041 = OpCompositeExtract %float %20369 1
      ...
      %23026 = OpCompositeExtract %float %11482 0
               OpBranch %17837
      %17837 = OpLabel
      %11196 = OpPhi %v2float %17970 %10087 %8892 %22449
      %14249 = OpPhi %v2float %889 %10087 %13062 %22449
               OpLoopMerge %15186 %22449 None
               OpBranch %14407
      %14407 = OpLabel
      ...
      %22449 = OpLabel
               OpBranch %17837
      %15186 = OpLabel
      %19994 = OpCompositeConstruct %v2float %float_0 %float_1
      %15731 = OpFMul %v2float %363 %19994
       %8459 = OpFAdd %v2float %705 %73
      %22451 = OpFAdd %v2float %15731 %1567
       %9732 = OpFMul %v2float %8459 %1633
      %23014 = OpFMul %v2float %22451 %1633
       %9252 = OpExtInst %v2float %1 Fma %9732 %14249 %23014
      ...
      %20409 = OpCompositeExtract %float %11482 1
               OpBranch %17838
      %17838 = OpLabel
      %11197 = OpPhi %v2float %10584 %15186 %8893 %22450
      %14250 = OpPhi %v2float %889 %15186 %13063 %22450
               OpLoopMerge %15187 %22450 None
               OpBranch %14373
      %14373 = OpLabel
      ...
      %22450 = OpLabel
               OpBranch %17838
      %15187 = OpLabel
      %19995 = OpCompositeConstruct %v2float %float_0_5 %float_1
      %15807 = OpFMul %v2float %363 %19995
      %24589 = OpFAdd %v2float %15807 %1567
       %8165 = OpFMul %v2float %24589 %1633
      %25097 = OpExtInst %v2float %1 Fma %9732 %14250 %8165
      ...
      %16092 = OpCompositeConstruct %v2float %float_0 %float_0
      %24206 = OpCompositeConstruct %v2float %float_1 %float_1
      %17435 = OpExtInst %v2float %1 FClamp %14695 %16092 %24206
      ...
      %23027 = OpCompositeExtract %float %11482 2
               OpBranch %17839
      %17839 = OpLabel
      %11198 = OpPhi %v2float %17971 %10088 %22330 %22453
      %14251 = OpPhi %v2float %312 %10088 %20851 %22453
               OpLoopMerge %14352 %22453 None
               OpBranch %14374
      %14374 = OpLabel
      ...
      %10884 = OpCompositeConstruct %v2float %float_0 %float_1
      %11501 = OpFMul %v2float %363 %10884
       %8460 = OpFAdd %v2float %705 %73
      %22454 = OpFAdd %v2float %11501 %1567
       %9733 = OpFMul %v2float %8460 %1633
      %23015 = OpFMul %v2float %22454 %1633
       %9253 = OpExtInst %v2float %1 Fma %9733 %18361 %23015
      ...
      %20410 = OpCompositeExtract %float %11482 3
               OpBranch %17840
      %17840 = OpLabel
      %11199 = OpPhi %v2float %10585 %14352 %22331 %22456
      %14252 = OpPhi %v2float %312 %14352 %20852 %22456
               OpLoopMerge %14353 %22456 None
               OpBranch %14408
      %14408 = OpLabel
      ...
      %10885 = OpCompositeConstruct %v2float %float_0_5 %float_1
      %11577 = OpFMul %v2float %363 %10885
      %24590 = OpFAdd %v2float %11577 %1567
       %8166 = OpFMul %v2float %24590 %1633
      %25098 = OpExtInst %v2float %1 Fma %9733 %18362 %8166
      ...
      %16093 = OpCompositeConstruct %v2float %float_0 %float_0
      %24207 = OpCompositeConstruct %v2float %float_1 %float_1
      %17436 = OpExtInst %v2float %1 FClamp %14696 %16093 %24207

...
void main()
{
    vec2 _8417 = texture(_3899, _4945).xy;
    vec4 _8059;
    vec2 _9910;
    if (_8417.y > 0.0)
    {
        ...
        if (_8417.x > 0.0)
        {
            ...
            for (;;)
            {
                ...
                if (_10367)
                {
                    ...
                    _15275 = textureLod(_3899, _20460.xy, 0.0).xy;
                    _10993 = _20460;
            ...
            _24094.x = vec4(_14247.zw.x, _16660.y, _14247.zw.y, _16660.w).x + float(_11194.y > 0.89999997615814208984375);
            _9402 = _24094;
        }
        else
        {
        ...
        vec3 _9034 = vec3(_4930._m0.xy, 1.0);
        vec4 _11078;
        _11078 = _18242;
        vec4 _10994;
        for (;;)
        {
            ...
            if (_10368)
            {
                vec3 _16026 = fma(_9034, vec3(1.0, _8525, 1.0), _11078.xyz);
        ...
        vec2 _19748;
        if ((vec4(_9402.x, _11078.zw.x, _9402.z, _11078.zw.y).x + vec4(_9402.x, _11078.zw.x, _9402.z, _11078.zw.y).y) > 2.0)
        {
            float _14575 = -vec4(_9402.x, _11078.zw.x, _9402.z, _11078.zw.y).x;
            vec4 _12161 = fma(vec4(_14575 + 0.25, _14575, vec4(_9402.x, _11078.zw.x, _9402.z, _11078.zw.y).y, -((-vec4(_9402.x, _11078.zw.x, _9402.z, _11078.zw.y).y) - 0.25)), _4930._m0.xyxy, _4945.xyxy);
            ...
            vec2 _21365 = _21918;
            _21365.y = 1.0 - (_21918.y + (0.14285714924335479736328125 * 0.0));
            _19748 = vec2(0.0) + textureLod(_4961, _21365, 0.0).xy;
        }
        else
        {
            _19748 = vec2(0.0);
        ...
        for (;;)
        {
            ...
            if (_10369)
            {
                vec3 _16027 = fma(_9034, vec3(-1.0, _8525, 1.0), _11079.xyz);
                vec4 _20462 = vec4(_16027.x, _16027.y, _16027.z, _11079.w);
                vec2 _8764 = textureLod(_3899, _20462.xy, 0.0).xy;
                float _21600 = _8764.x;
                vec2 _22877 = _8764;
        ...
        if (textureLodOffset(_3899, _4945, 0.0, ivec2(1, 0)).x > 0.0)
        {
            ...
            for (;;)
            {
                ...
                if (_10370)
                {
                    vec3 _16028 = fma(_9034, vec3(1.0, -1.0, 1.0), _14248.xyz);
                    vec4 _20463 = vec4(_16028.x, _16028.y, _16028.z, _14248.w);
                    vec2 _8765 = textureLod(_3899, _20463.xy, 0.0).xy;
                    float _21601 = _8765.x;
                    vec2 _22878 = _8765;
            ...
            _24095.y = vec4(vec4(_11079.zw.x, vec4(_9402.x, _11078.zw.x, _9402.z, _11078.zw.y).y, _11079.zw.y, vec4(_9402.x, _11078.zw.x, _9402.z, _11078.zw.y).w).x, _14248.zw.x, vec4(_11079.zw.x, vec4(_9402.x, _11078.zw.x, _9402.z, _11078.zw.y).y, _11079.zw.y, vec4(_9402.x, _11078.zw.x, _9402.z, _11078.zw.y).w).z, _14248.zw.y).y + float(_11195.y > 0.89999997615814208984375);
            _17360 = _24095;
        }
        else
        {
        ...
        {
            float _14921 = -_17360.x;
            vec4 _12162 = fma(vec4(_14921, -_14921, _17360.y, -_17360.y), _4930._m0.xyxy, _4945.xyxy);
            ...
            vec2 _21366 = _21919;
            _21366.y = 1.0 - (_21919.y + (0.14285714924335479736328125 * 0.0));
        ...
        vec4 _11251;
        vec2 _13709;
        if (vec4(_17706.x, _17706.y, vec4(0.0).z, vec4(0.0).w).x == (-vec4(_17706.x, _17706.y, vec4(0.0).z, vec4(0.0).w).y))
        {
            vec2 _11196;
            vec2 _14249;
            _11196 = _3809.xy;
            ...
            for (;;)
            {
                ...
                if (_10371)
                {
                    _13062 = textureLod(_3899, _11196, 0.0).xy;
                    _8892 = fma(vec2(-2.0, -0.0), _4930._m0.xy, _11196);
                    _11196 = _8892;
                    _14249 = _13062;
                    continue;
                }
            ...
            vec2 _9732 = (vec2(33.0, -33.0) + vec2(-1.0, 1.0)) * vec2(0.015625, 0.0625);
            vec2 _9252 = fma(_9732, _14249, ((vec2(66.0, 33.0) * vec2(0.0, 1.0)) + vec2(0.5, -0.5)) * vec2(0.015625, 0.0625));
            vec2 _14938 = _9252;
            ...
            for (;;)
            {
                ...
                if (_10372)
                {
                    _13063 = textureLod(_3899, _11197, 0.0).xy;
                    _8893 = fma(vec2(2.0, 0.0), _4930._m0.xy, _11197);
                    _11197 = _8893;
                    _14250 = _13063;
                    continue;
                }
            ...
            vec2 _25097 = fma(_9732, _14250, ((vec2(66.0, 33.0) * vec2(0.5, 1.0)) + vec2(0.5, -0.5)) * vec2(0.015625, 0.0625));
            vec2 _10134 = _25097;
    ...
    if (_9910.x > 0.0)
    {
        ...
        for (;;)
        {
            ...
            if (_10373)
            {
                _20851 = textureLod(_3899, _11198, 0.0).xy;
                _22330 = fma(vec2(-0.0, 2.0), _4930._m0.xy, _11198);
                _11198 = _22330;
                _14251 = _20851;
                continue;
            }
        ...
        vec2 _9733 = (vec2(33.0, -33.0) + vec2(-1.0, 1.0)) * vec2(0.015625, 0.0625);
        vec2 _9253 = fma(_9733, _14251.yx, ((vec2(66.0, 33.0) * vec2(0.0, 1.0)) + vec2(0.5, -0.5)) * vec2(0.015625, 0.0625));
        vec2 _14939 = _9253;
        ...
        for (;;)
        {
            ...
            if (_10374)
            {
                _20852 = textureLod(_3899, _11199, 0.0).xy;
                _22331 = fma(vec2(0.0, -2.0), _4930._m0.xy, _11199);
                _11199 = _22331;
                _14252 = _20852;
                continue;
            }
        ...
        vec2 _25098 = fma(_9733, _14252.yx, ((vec2(66.0, 33.0) * vec2(0.5, 1.0)) + vec2(0.5, -0.5)) * vec2(0.015625, 0.0625));
        vec2 _10135 = _25098;
